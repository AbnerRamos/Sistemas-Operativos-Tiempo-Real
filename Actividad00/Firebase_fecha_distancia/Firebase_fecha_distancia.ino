//Funcionameno:
//1. Conectarse a wifi y obtener a fecha y hora
//2. Calcular una distancia con ayuda de un sensor ultrasonico
//3. Interacción con base de dato Firebase
//4. Publicar en la base de datos la fecha y la distancia calcuada.
