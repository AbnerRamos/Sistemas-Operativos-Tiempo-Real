...
//En este codigo contamos con dos tareas, una de ellas envia "Mensaje inicial --- UPIIZ ---"
//y la otra envia "*" por UART, como la primera tiene prioridad sobre la segunda, el primer
//mensaje que se envia es el de esta tarea, pero como esta se detiene por algunos periodos de
//tiempo cada 3 digitos imprimidos, es posible que se impriman "*" entre medio, pasado un 
//tiempo se borra la actividad de baja prioridad, por lo que ahora unicamente se imprime "*"
